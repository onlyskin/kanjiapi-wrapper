...
const{ApiWrapper,ERROR,SUCCESS,LOADING}=require("./api_wrapper"),API_URL="https://kanjiapi.dev";Kanjiapi={build:()=>new ApiWrapper(window.fetch.bind(window),API_URL)},module.exports={Kanjiapi,Result:{ERROR,SUCCESS,LOADING}};
