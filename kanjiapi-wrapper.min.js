...
const{ApiWrapper,ERROR,SUCCESS,LOADING}=require("./api_wrapper"),API_URL="https://kanjiapi.dev";Kanjiapi={build:a=>new ApiWrapper(window.fetch.bind(window),API_URL,a),ERROR,SUCCESS,LOADING},module.exports={Kanjiapi};
